...
public final class Constants {
    ...
    public static final float RECEIVER_HEIGHT = 100;     // Height of receiver tube
    public static final float RECEIVER_DIAMETER = 16;    // Diameter of receiver tube
    public static final float REFLECTOR_WIDTH = 25;      // Width of each mirror
    public static final float REFLECTOR_LENGTH = 100;    // Length of each mirror (1 meter)
    public static final float REFLECTOR_SPACING = 40;    // Spacing between mirrors
    public static final float SUPPORT_HEIGHT = 25;       // Height of mirror supports
